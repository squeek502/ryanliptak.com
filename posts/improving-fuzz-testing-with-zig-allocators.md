...
<aside class="note"><p>**Note:** In reality, I further [(conditionally) wrapped](https://github.com/squeek502/audiometa/blob/a9f46daa31756acef58558b3d06a6b9864e3f570/test/fuzz-oom.zig#L32-L45) the `FailingAllocator` in a [custom `StackTraceOnErrorAllocator`](https://github.com/squeek502/audiometa/blob/a9f46daa31756acef58558b3d06a6b9864e3f570/test/fuzz-oom.zig#L69-L108) in order to dump a stack trace at the point of the induced `OutOfMemory` error to make it easier to debug the problems found.</p></aside>
