...
lex:add_rule('measurementline',
  ...
  token(lexer.WHITESPACE, lexer.space^1) * (token('outliers', lexer.number * lexer.space^1 * P("(1") * -S")" * P")") + token(lexer.COMMENT, lexer.number * lexer.space^1 * lexer.range('(', ')', true, false, true))) *
