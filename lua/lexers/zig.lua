...
-- Built-in functions.
lex:add_rule('builtin', token(lexer.FUNCTION, '@' * word_match{
...
lex:add_rule('function', -lpeg.B('@') * token(lexer.FUNCTION, lexer.alpha * lexer.word^1) * lexer.space^0 * token('punctuation', P("(")))
